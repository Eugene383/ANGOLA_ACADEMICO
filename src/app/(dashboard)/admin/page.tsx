      ...
      <div className="bg-white rounded-lg sm:rounded-xl border border-gray-200 p-4 sm:p-5">
        <div className="flex flex-col sm:flex-row sm:items-center gap-4">
          <div className="flex items-center gap-3 flex-shrink-0">
            <div className="w-8 sm:w-9 h-8 sm:h-9 bg-pink-50 rounded-lg flex items-center justify-center flex-shrink-0">
              <TrendingUp className="w-4 sm:w-5 h-4 sm:h-5 text-pink-600" />
            </div>
            <div>
              <p className="text-xl sm:text-2xl font-semibold text-gray-900">{stats.taxaFeminizacao}%</p>
              <p className="text-xs sm:text-sm text-gray-600">Taxa de feminização</p>
            </div>
          </div>
