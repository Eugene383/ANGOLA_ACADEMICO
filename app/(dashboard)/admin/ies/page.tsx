...
<<<<<<< HEAD:src/app/(dashboard)/admin/ies/page.tsx
  const { ies, loading, refetch } = useIES({
=======
  const { ies, loading } = useIES({
>>>>>>> 9d0e92bd8298e8343bddeae7d5250d49f09d22fc:app/(dashboard)/admin/ies/page.tsx
...
<<<<<<< HEAD:src/app/(dashboard)/admin/ies/page.tsx
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          <div>
            <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2">Província</label>
=======
...
>>>>>>> 9d0e92bd8298e8343bddeae7d5250d49f09d22fc:app/(dashboard)/admin/ies/page.tsx
          ...
          <div>
<<<<<<< HEAD:src/app/(dashboard)/admin/ies/page.tsx
            <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2">Natureza</label>
=======
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="px-3 sm:px-5 py-2 sm:py-3 text-left text-xs font-semibold text-gray-700 whitespace-nowrap">Ações</th>
=======
...
<<<<<<< HEAD:src/app/(dashboard)/admin/ies/page.tsx
          <div className="px-3 sm:px-5 py-2 sm:py-3 bg-gray-50 border-t border-gray-200 text-xs text-gray-600">
=======
